        ...
        return new Promise<NgbModalRef>((resolve, reject) => {
            ...
            if (id) {
                this.companyService.find(id).subscribe((company) => {
                    company.createdDate = this.datePipe
                        .transform(company.createdDate, 'yyyy-MM-ddTHH:mm:ss');
                    company.lastModifiedDate = this.datePipe
                        .transform(company.lastModifiedDate, 'yyyy-MM-ddTHH:mm:ss');
