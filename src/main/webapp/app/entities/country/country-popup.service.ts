        ...
        return new Promise<NgbModalRef>((resolve, reject) => {
            ...
            if (id) {
                this.countryService.find(id).subscribe((country) => {
                    country.createdDate = this.datePipe
                        .transform(country.createdDate, 'yyyy-MM-ddTHH:mm:ss');
                    country.lastModifiedDate = this.datePipe
                        .transform(country.lastModifiedDate, 'yyyy-MM-ddTHH:mm:ss');
