...
import ua.com.sngtrans.plenary.domain.PersistentToken;
...
import ua.com.sngtrans.plenary.service.MailService;
import ua.com.sngtrans.plenary.service.UserService;
import ua.com.sngtrans.plenary.service.dto.UserDTO;
import ua.com.sngtrans.plenary.web.rest.vm.KeyAndPasswordVM;
import ua.com.sngtrans.plenary.web.rest.vm.ManagedUserVM;
...
public class AccountResource {
                ...
                .orElseGet(() -> {
                    User user = userService
                        .createUser(managedUserVM.getLogin(), managedUserVM.getPassword(),
                            managedUserVM.getFirstName(), managedUserVM.getLastName(), managedUserVM.getCompany(),
    ...
    public ResponseEntity saveAccount(@Valid @RequestBody UserDTO userDTO) {
        ...
        return userRepository
            ...
            .map(u -> {
                userService.updateUser(userDTO.getFirstName(), userDTO.getLastName(),userDTO.getCompany(), userDTO.getEmail(),
