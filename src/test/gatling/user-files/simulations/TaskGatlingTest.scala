...
class TaskGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Task entity")
        ...
        .repeat(2) {
            ...
            .post("/api/tasks")
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "number":"SAMPLE_TEXT", "date":"2020-01-01T00:00:00.000Z", "fullName":"SAMPLE_TEXT", "invoiceNumber":"SAMPLE_TEXT", "invoiceDate":"2020-01-01T00:00:00.000Z", "weight":null, "volume":null, "dateOfExecution":"2020-01-01T00:00:00.000Z", "comment":"SAMPLE_TEXT", "createdBy":"SAMPLE_TEXT", "createdDate":"2020-01-01T00:00:00.000Z", "lastModifiedBy":"SAMPLE_TEXT", "lastModifiedDate":"2020-01-01T00:00:00.000Z"}""")).asJSON
            .check(status.is(201))
