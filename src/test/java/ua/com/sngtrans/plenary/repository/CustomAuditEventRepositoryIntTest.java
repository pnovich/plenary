...
import ua.com.sngtrans.plenary.config.audit.AuditEventConverter;
import ua.com.sngtrans.plenary.domain.PersistentAuditEvent;
...
@SpringBootTest(classes = PlenaryErpApp.class)
@Transactional
